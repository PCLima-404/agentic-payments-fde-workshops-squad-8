...
|---|---|---|
| `auth/` | Pessoa 1 | API de autenticação (login/JWT) |
| `tickets-tools/` | Pessoa 2 | Servidor MCP com as 3 tools (catálogo, intenção, compra) |
| `gemini-chat/` | Pessoa 3 | Frontend + agente (Gemini API + MCP client) |
